...
<!--      <p>A: 模拟器的抽卡概率是根据公开的规则和个人体感调整而来，实际游戏中可能有更细微的机制控制歪得不离谱。模拟器的抽卡结果仅供参考。</p>-->
      <p>Q: 图片加载不出来？</p>
      <p>A: 图片引用自外网的英文 Wiki，我们也很难控制。加载失败可能是访问外网的网络波动，可以多尝试。也可能是手机浏览器的兼容性问题（例如低版本 iOS 等）。</p>
      ...
      <h3>关于抽卡模拟器</h3>
      <p>抽卡模拟器项目仅供个人学习与娱乐用途。所有游戏素材版权属于乐元素官方，卡池数据和图片主要来自偶像梦幻祭英文 Wiki，感谢维护者们的辛勤付出。若官方/Wiki 人员认为有任何不妥之处，请联系我们，我们将立即处理。</p>
      <h3>关于我们</h3>
